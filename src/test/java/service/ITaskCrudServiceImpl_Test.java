...
public class ITaskCrudServiceImpl_Test {
    ...
    XMLTransformer parser;
    TaskCrudService service;

    public ITaskCrudServiceImpl_Test() {
        this.parser = new XMLTransformer();
        this.service = new TaskCrudService(parser);
    }
